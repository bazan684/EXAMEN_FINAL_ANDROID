...
public class AgregarMusica extends AppCompatActivity {
    ...
    TextView /*Añadido en video anterior*/IdMusica, VistaMusica;
    ...
    private void EliminarImagenAnterior() {
        ...
        Imagen.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(AgregarMusica.this,
                        "La imagen anterior a sido eliminada", Toast.LENGTH_SHORT).show();
                SubirNuevaImagen();
            }
    ...
    private void SubirNuevaImagen() {
        ...
        StorageReference mStorageReference2 = mStorageReference.child(
                RutaDeAlmacenamiento + nuevaImagen);
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(AgregarMusica.this, "Nueva imagen cargada",
    ...
    private void ActualizarImagenBD(final String NuevaImagen) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(AgregarMusica.this, "Actualizado correctamente",
                        Toast.LENGTH_SHORT).show();
            ...
            storageReference2.putFile(RutaArchivoUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            /*Añadido en video anterior*/
                            Musica musica = new Musica(mNombre+"/"+mId,downloadURI.toString(),
                                    mNombre,VISTA);
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(AgregarMusica.this, "Subido Exitosamente",
                                    Toast.LENGTH_SHORT).show();
